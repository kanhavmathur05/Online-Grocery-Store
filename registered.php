		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="registrationdetails.php" method="post">
					...
					<input type="text" name="user_city" placeholder="City" required=" " style="margin-top: 15px;">
					<input type="text" name="user_state" placeholder="State" required=" " style="margin-top: 15px;">
					<input type="text" name="user_contactno" placeholder="Contact Number" required=" " style="margin-top: 15px;">
				...
				<h6>Login information</h6>
					...
					<input type="password" name="user_confirmpass" placeholder="Password Confirmation" required=" " >
					<div class="register-check-box">
						<div class="check">
